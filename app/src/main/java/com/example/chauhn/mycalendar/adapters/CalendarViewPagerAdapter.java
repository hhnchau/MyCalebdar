package com.example.chauhn.mycalendar.adapters;
...
import com.example.chauhn.mycalendar.views.CalendarDayView;
import com.example.chauhn.mycalendar.views.CalendarMonthView;
...
public class CalendarViewPagerAdapter extends PagerAdapter implements OnDayViewClickListener {
    ...
    public CalendarViewPagerAdapter(List<CalendarMonth> listMonth, CalendarDate selected, ViewPager viewPager) {
        mData = listMonth;
